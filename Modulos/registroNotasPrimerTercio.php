    ...
    <div class="container">
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item active"><a class="page-link" href="../Modulos/registroNotasPrimerTercio.php">Primer
                        Tercio</a></li>
                <li class="page-item"><a class="page-link" href="../Modulos/registroNotasSegundoTercio.php">Segundo
                        Tercio</a></li>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php $T1=$con->notas_Actividades_Estudiantes($fE["Id"],$_SESSION["periodo"],'Primer Tercio','Taller 1')?>
                    <?php $T2=$con->notas_Actividades_Estudiantes($fE["Id"],$_SESSION["periodo"],'Primer Tercio','Taller 2')?>
                    <?php $TO=$con->notas_Actividades_Estudiantes($fE["Id"],$_SESSION["periodo"],'Primer Tercio','Taller opcional')?>
                    <?php $P1=$con->notas_Actividades_Estudiantes($fE["Id"],$_SESSION["periodo"],'Primer Tercio','Parcial')?>
                    ...
                    <?php $cantidad_Clases=$con->contar_clases($fE["Id"],"Primer Tercio");?>
                    <?php $cantidad_Asistencia=$con->contar_Asistencia($fE["Id"],"Primer Tercio");?>
                        ...
                        <div class="modal fade" id="exampleModal<?php echo $fE["Id"]?>" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="../Modulos/registroNotasPrimerTercio.php">
