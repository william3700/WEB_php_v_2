        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="../Modulos/registroNotasSegundoTercio.php">Segundo
                        Tercio</a></li>
                <li class="page-item active"><a class="page-link" href="../Modulos/registroNotasTercerTercio.php">Tercer
                        Tercio</a></li>
                <li class="page-item">
                        ...
                        <div class="modal fade" id="exampleModal<?php echo $fE["Id"]?>" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="../Modulos/registroNotasTercerTercio.php">
